...
class OptionsButton(Button):
    ...
    def click(self, pos):
        self.game_state.next_state = lambda game, prev_state: main.OptionsState(game, prev_state)


def load_world(screen_size, pattern, elements) -> World:
    world = World()
